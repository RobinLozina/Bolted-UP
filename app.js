...
$("#btnSend")
  ...
  .on("click", function () {
    ...
    if (
      ...
      if (document.getElementById("typeFilet1").checked) {
        // Si le type de filet est métrique
      ...
      } else if (document.getElementById("typeFilet2").checked) {
        // Si le type de filet est Withworth ou Gaz
      ...
      } else if (document.getElementById("typeFilet3").checked) {
        // Si le type de filet est Trapézoïdal
        console.log("Trapeze");
        var typePas = 0;
        if (document.getElementById("typePas2").checked) {
          typePas = 1;
...
$("#typeFilet").click(function () {
  // Afficher le bon champ en fonction du type de filet et reset l'autre champ
...
function AfficherTableau(reponse) {
  ...
  if (reponse[0].length == 11) {
    // Si le type de filet est WithGaz
    console.log("WithGaz");
    if (document.getElementById("typeElement1").checked) {
      // Si le type d'élément est une vis
      ...
      // Si le type d'élément est un ecrou
    ...
    // Si le type de filet est Metrique
    console.log("METRIQUE");
    if (document.getElementById("typeElement1").checked) {
      // Si le type d'élément est une vis
